...
export const GET_SERVER_CONNECTION_HISTORY = ({ myAddress }) => {
...
`.trim();
  ...
  const tsInterface = `
interface GetServerConnectionHistoryRequest {
  action: string;
  coin: string;
}
`.trim();
  ...
  return (
    ...
    >
      <GeneralExplanation>
        ...
        Returns foreign coin server connection history
        </Typography>
      </GeneralExplanation>
      ...
      <Card>
        ...
        <div className="message-row">
          ...
          >
            ...
            {coins?.filter((item)=> item.name !== 'QORT')?.map((coin) => {
              return (
